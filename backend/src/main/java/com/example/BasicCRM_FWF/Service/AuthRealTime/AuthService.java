...
public class AuthService {
    ...
    public String getToken() throws Exception {
        ...
        System.out.println("🔄 Token hết hạn hoặc chưa có, tiến hành login...");
        ...
        payload.add("txtUserName", "anhlh");
        payload.add("txtPassword", "1234");
        ...
        throw new RuntimeException("Login thất bại, không lấy được token!");
    }
}
